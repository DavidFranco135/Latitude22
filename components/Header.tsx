  ...
  return (
    <header className="sticky top-0 z-10 flex h-16 w-full items-center justify-between border-b border-white/5 bg-stone-900 px-4 md:px-8 shadow-md">
      <div className="flex items-center space-x-4">
        <button
          onClick={onMenuClick}
          className="md:hidden p-2.5 rounded-lg hover:bg-stone-800 text-stone-400 hover:text-amber-500 transition-colors active:scale-95"
        ...
        <div className="relative w-full md:w-64">
          ...
          <input
            ...
            className="w-full rounded-full border border-white/10 bg-stone-950 py-1.5 pl-9 pr-4 text-sm text-stone-200 focus:border-amber-600 focus:outline-none focus:ring-1 focus:ring-amber-600 transition-all placeholder:text-stone-600"
          />
        </div>
      </div>
